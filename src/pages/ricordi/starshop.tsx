      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 border border-amber-100 text-center max-w-4xl mx-auto">
          <p className="text-xl text-gray-700 leading-relaxed">
            Il 13 Aprile e il 15 Novembre 2025 l'Avamposto Garibaldino ha tenuto una collaborazione con Starshop di Fonte Nuova per diffondere la passione degli scacchi.
          </p>
        </div>
