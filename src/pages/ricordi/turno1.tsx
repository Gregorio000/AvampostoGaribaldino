      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-12 border border-amber-100 text-center max-w-4xl mx-auto">
          <p className="text-xl text-gray-700 leading-relaxed">
            1° Turno Campionato a Squadre FSI.
            Nel primo turno del campionato Serie Promozione le squadre esordienti Black e White dell'Avamposto Garibaldino registrano la vittoria per 2,5 a 1,5 nel derby delle ore 15 contro le squadre di Monterotondo "Eretum Scacchi" e "Eretum Juniores". 
