...
const risultati = [
  {
    ...
    avversario: "Eretum Scacchi",
    sede: "Monterotondo",
    punteggio: "2,5 – 1,5",
    girone: "Girone 1",
    highlight: "Esordio vincente per i Black nel derby con Monterotondo.",
  },
  {
    colore: "WHITE",
    ...
    esito: "VITTORIA",
    esitoStyle: "bg-green-100 text-green-700",
    avversario: "Eretum Juniores",
    sede: "Monterotondo",
    punteggio: "2,5 – 1,5",
    girone: "Girone 2",
    highlight: "Ottimo esordio anche per i White nel derby di Monterotondo.",
  },
  {
    colore: "BLUE",
    ...
    avversario: "Club 4 Pedoni Balduina",
    sede: "Roma",
    punteggio: "2 – 2",
    girone: "Girone 3",
    highlight: "Prezioso pari in trasferta contro la solida formazione romana.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-chess-dark leading-tight mb-5">
            1° Turno <span className="text-chess-gold">Campionato a Squadre FSI</span>
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-10 max-w-3xl mx-auto text-center">
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
            Un vero sogno hanno vissuto tifosi e giocatori dell'Avamposto Garibaldino nel primo turno del
            campionato. Derby vinto da Black e White contro Monterotondo, pari prezioso per il Blue a Roma.
          </p>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-400 text-sm">
            1° Turno Serie Promozione · 1 Febbraio 2026 · Avamposto Garibaldino
          </p>
        </div>
