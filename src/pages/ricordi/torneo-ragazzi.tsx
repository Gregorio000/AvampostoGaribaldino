      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-chess-dark leading-tight mb-4">
            4° Torneo <span className="text-chess-gold">Under 16</span>
          </h1>
          <p className="text-lg text-gray-500 max-w-xl mx-auto">
            Torneo giovani promesse under 16 e neofiti · Via Giovanni Giolitti 21/23, Mentana
          </p>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-400 text-sm">
            4° Torneo Under 16 · Avamposto Garibaldino · Mentana
          </p>
        </div>
