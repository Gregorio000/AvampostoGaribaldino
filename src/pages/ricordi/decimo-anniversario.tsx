...
const photos = [
  ...
  ...Array.from({ length: 59 }, (_, i) => `/decimo-anniversario/decimo-anniversario-${i + 1}.jpeg`),
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-chess-dark leading-tight mb-4">
            Torneo <span className="text-chess-gold">10° Anniversario</span>
          </h1>
          <p className="text-lg text-gray-500 max-w-xl mx-auto">
            Un torneo speciale per celebrare dieci anni di scacchi a Mentana · Via Giovanni Giolitti 21/23
          </p>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-400 text-sm">
            Torneo 10° Anniversario · 15 Giugno 2025 · Avamposto Garibaldino
          </p>
        </div>
