...
const photos = [
  ...
  ...Array.from({ length: 18 }, (_, i) => `/centro-estivo/centro-estivo${i + 1}.jpg`),
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-chess-dark leading-tight mb-4">
            Centro <span className="text-chess-gold">Estivo</span>
          </h1>
          <p className="text-lg text-gray-500 max-w-xl mx-auto">
            Scacchi, sport e creatività per bambini dai 3 ai 14 anni · Monterotondo Scalo
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-12 max-w-3xl mx-auto text-center">
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
            Un centro estivo speciale organizzato nel <span className="font-semibold text-chess-dark">2020</span>,
            dove abbiamo unito la passione degli scacchi con sport e attività creative in un'esperienza
            indimenticabile per i più giovani.
          </p>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-400 text-sm">
            Centro Estivo · Estate 2020 · Avamposto Garibaldino
          </p>
        </div>
