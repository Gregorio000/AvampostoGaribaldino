...
const risultati = [
  {
    ...
    avversario: "Alfieri della Tuscia 4",
    sede: "Nepi",
    punteggio: "2 – 2",
    girone: "Girone 1",
    highlight: "Vittorie di Gismondi (in 30 mosse) e Ventilii. Secondo pareggio consecutivo in una partita combattuta.",
  },
  {
    colore: "WHITE",
  ...
  },
  {
    ...
    avversario: "Easy Scacchi",
    sede: "Roma",
    punteggio: "3 – 1",
    girone: "Girone 3",
    highlight: "Vittoria sofferta ma meritata. L'esperienza dei garibaldini ha fatto la differenza nei finali.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-chess-dark leading-tight mb-5">
            4° Turno <span className="text-chess-gold">Campionato a Squadre FSI</span>
          </h1>
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-400 text-sm">
            4° Turno Serie Promozione · 1 Marzo 2026 · Avamposto Garibaldino
          </p>
        </div>
